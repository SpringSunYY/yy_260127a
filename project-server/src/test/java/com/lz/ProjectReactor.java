...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "com.lz.project";
    private static final String ARTIFACT_ID = "project";
    private static final String PACKAGE_NAME = "com.lz";
    private static final String TITLE = "昊阳建筑";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "com.lz.project";
        String artifactIdNew = "project";
        String packageNameNew = "com.lz";
        String titleNew = "昊阳建筑";
