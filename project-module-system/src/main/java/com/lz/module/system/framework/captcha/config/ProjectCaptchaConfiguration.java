package com.lz.module.system.framework.captcha.config;

import com.lz.module.system.framework.captcha.core.RedisCaptchaServiceImpl;
...
public class ProjectCaptchaConfiguration {
