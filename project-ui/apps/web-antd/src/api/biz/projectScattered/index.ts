...
export function getProjectScatteredPage(params: PageParam) {
  return requestClient.get<PageResult<ProjectScatteredApi.ProjectScattered>>(
    '/biz/project-scattered/page',
    { params },
  );
}
...
export function getProjectScattered(id: number) {
  return requestClient.get<ProjectScatteredApi.ProjectScattered>(
    `/biz/project-scattered/get?id=${id}`,
  );
}

/** 新增零散工程 */
export function createProjectScattered(
  data: ProjectScatteredApi.ProjectScattered,
) {
  return requestClient.post('/biz/project-scattered/create', data);
}

/** 修改零散工程 */
export function updateProjectScattered(
  data: ProjectScatteredApi.ProjectScattered,
) {
...
export function deleteProjectScatteredList(ids: number[]) {
  return requestClient.delete(
    `/biz/project-scattered/delete-list?ids=${ids.join(',')}`,
  );
}
...
/** 导入项目信息模版 */
export function importProjectScatteredTemplate() {
  return requestClient.download('/biz/project-scattered/get-import-template');
}
