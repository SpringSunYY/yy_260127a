...
/** 编辑供应商信息 */
function handleEdit(row: SupplierApi.Supplier) {
...
async function handleExport() {
  ...
  downloadFileFromBlobPart({ fileName: '供应商信息.xls', source: data });
}
    ...
    <Grid table-title="供应商信息列表">
      <template #toolbar-tools>
        <TableAction
          :actions="[
            {
              label: $t('ui.actionTitle.create', ['供应商信息']),
              type: 'primary',
