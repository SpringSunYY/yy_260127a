...
import com.lz.framework.redis.config.ProjectCacheProperties;
...
@AutoConfiguration
@ConditionalOnProperty(prefix = "project.tenant", value = "enable", matchIfMissing = true) // 允许使用 project.tenant.enable=false 禁用多租户
