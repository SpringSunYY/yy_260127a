package com.lz.framework.ratelimiter.config;

import com.lz.framework.ratelimiter.core.aop.RateLimiterAspect;
import com.lz.framework.ratelimiter.core.keyresolver.RateLimiterKeyResolver;
import com.lz.framework.ratelimiter.core.keyresolver.impl.*;
import com.lz.framework.ratelimiter.core.redis.RateLimiterRedisDAO;
...
public class ProjectRateLimiterConfiguration {
