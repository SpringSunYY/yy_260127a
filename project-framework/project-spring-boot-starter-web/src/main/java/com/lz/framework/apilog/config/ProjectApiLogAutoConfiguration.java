package com.lz.framework.apilog.config;

import com.lz.framework.apilog.core.filter.ApiAccessLogFilter;
import com.lz.framework.apilog.core.interceptor.ApiAccessLogInterceptor;
...
import com.lz.framework.web.config.ProjectWebAutoConfiguration;
...
@AutoConfiguration(after = ProjectWebAutoConfiguration.class)
