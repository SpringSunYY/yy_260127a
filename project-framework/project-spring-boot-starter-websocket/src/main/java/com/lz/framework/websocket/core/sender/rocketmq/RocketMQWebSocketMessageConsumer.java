package com.lz.framework.websocket.core.sender.rocketmq;
...
@RocketMQMessageListener( // 重点：添加 @RocketMQMessageListener 注解，声明消费的 topic
        topic = "${project.websocket.sender-rocketmq.topic}",
        consumerGroup = "${project.websocket.sender-rocketmq.consumer-group}",
